  ...
  if (!admin.apps.length) {
    admin.initializeApp({
      credential: admin.credential.cert({
        ...
        private_key_id:
          process.env.NEXT_PRIVATE_FIREBASE_ADMIN_SDK_PRIVATE_KEY_ID,
        ...
        auth_provider_x509_cert_url:
          process.env
            .NEXT_PRIVATE_FIREBASE_ADMIN_SDK_AUTH_PROVIDER_X509_CERT_URL,
        client_x509_cert_url:
          process.env.NEXT_PRIVATE_FIREBASE_ADMIN_SDK_CLIENT_X509_CERT_URL,
        universe_domain:
          process.env.NEXT_PRIVATE_FIREBASE_ADMIN_SDK_UNIVERSE_DOMAIN,
      } as ServiceAccount),
    });
  }
}
